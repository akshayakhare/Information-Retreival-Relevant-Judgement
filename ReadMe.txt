...
2. Unzip the file "Akshaya_Khare_CS6200_HW5.zip" to get the contents
3. The file 'HW_5.py' is the main file which contains the source code to find precision, recall and NDCG values
4. The file 'HW_5.py' takes no arguments, and expects 2 files to be available within the same directory as the 'HW_5.py'
...
5. The folder "HW3 related" contains all the files for running the result for input from HW_3 and
	The folder "HW4 related" contains all the files for running the result for input from HW_4
6. The two "HW_5.py" files in different folders have just one line changes for getting the input
7. The main file in the outside folder uses HW_4 as an input.
